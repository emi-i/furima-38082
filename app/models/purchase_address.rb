class PurchaseAddress
  ...
  validates :post_code, presence: true, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'はハイフンを入力してください' }
  validates :tel, presence: true, format: { with: /\A\d{10,11}\z/, message: "は半角文字で入力してください"}
